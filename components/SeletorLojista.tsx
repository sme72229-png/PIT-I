...
export default function SeletorLojista({ lojistas, valor, aoAlterar, desabilitado }: PropsSeletorLojista) {
  return (
    <div>
      ...
      <label htmlFor="seletor-lojista" className="block text-sm font-medium text-gray-200">
        Lojista
      </label>
      <select
        id="seletor-lojista"
        ...
        className="mt-2 block w-full max-w-lg cursor-pointer rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 focus-visible:border-yellow-400 focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2"
      >
