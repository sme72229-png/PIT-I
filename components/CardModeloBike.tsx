...
export default function CardModeloBike({ modelo, quantidade, aoAlterarQuantidade }: PropsCardModeloBike) {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg font-semibold">{formatarMoeda(modelo.preco_base)}</p>

      {/* Especificações técnicas com ícones informativos (potência/autonomia) */}
      <p className="mt-1 flex items-center gap-4 text-sm text-gray-500">
      ...
      <div className="mt-3">
        ...
        <label htmlFor={`qtd-${modelo.id_bike}`} className="text-sm font-medium">
